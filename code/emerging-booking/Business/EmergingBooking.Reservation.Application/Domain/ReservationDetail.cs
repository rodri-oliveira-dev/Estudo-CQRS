...
namespace EmergingBooking.Reservation.Application.Domain
{
    internal class ReservationDetail : Aggregate
    {
        public ReservationDetail(BookedHotel bookedHotel, BookedRoom bookedRoom,
            Period lengthOfPeriod, string bookedBy, int numberOfGuests, bool breakfastIncluded)
                : base (Guid.NewGuid())
        {
        ...
        public int NumberOfNights => Period.EvaluateNumberOfNights(LengthOfPeriod);
        ...
        private string GenerateReservationNumber()
        {
            ...
            return $"{i - LengthOfPeriod.Checkin.Ticks:x}";
        }
    }
